    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Save_Event.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if (eventsList.contains(Event_Name.getText().toString()) && getIntent().getExtras().getInt("Edit") == 1 && !Event_Name.getText().toString().equals(getIntent().getExtras().getString("EventName")))
                {
                    Toast.makeText(AdminEvent_Add.this, "Event already exists", Toast.LENGTH_LONG).show();
                }
                 else {
